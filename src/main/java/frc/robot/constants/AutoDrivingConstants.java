...
public class AutoDrivingConstants {
    ...
    public static final Transform2d TAG_TO_GOAL_CENTER = new Transform2d(new Translation2d(.23, 0), Rotation2d.fromDegrees(175.0));
    public static final Transform2d TAG_TO_GOAL_LEFT = new Transform2d(new Translation2d(.23, -0.3), Rotation2d.fromDegrees(175.0));
    ...
    public static final double PRECISE_AUTO_DRIVE_TRANSLATION_PID_MAX_ACCEL = 2;

    public static final double PRECISE_AUTO_DRIVE_TRANSLATION_PID_Kp = 1;
    public static final double PRECISE_AUTO_DRIVE_TRANSLATION_PID_Ki = 0;
    public static final double PRECISE_AUTO_DRIVE_TRANSLATION_PID_Kd = 0.0;

    public static final double PRECISE_AUTO_DRIVE_ROTATION_PID_MAX_SPEED = 250;
    public static final double PRECISE_AUTO_DRIVE_ROTATION_PID_MAX_ACCEL = 100;

    public static final double PRECISE_AUTO_DRIVE_ROTATION_PID_Kp = 0.4;
