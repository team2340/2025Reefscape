...
public class AutoDrivingConstants {
    ...
    public static final double PRECISE_POSITION_THRESHOLD = 0.05;
    ...
    public static final double PRECISE_AUTO_DRIVE_TRANSLATION_PID_Kp = 4;
    public static final double PRECISE_AUTO_DRIVE_TRANSLATION_PID_Ki = 0;
    public static final double PRECISE_AUTO_DRIVE_TRANSLATION_PID_Kd = 0.03;
